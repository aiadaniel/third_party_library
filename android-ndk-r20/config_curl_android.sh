...
case "$THE_ARCH" in
  arm|armv5|armv6|armv7|armeabi)
	...
	CC_PREFIX="armv7a-linux-androideabi$API_LEVEL-clang"
    AOSP_ABI="armeabi"
    AOSP_ARCH="arch-arm"
  ...
  armv8|armv8a|aarch64|arm64|arm64-v8a)
	...
	CC_PREFIX="aarch64-linux-android$API_LEVEL-clang"
    AOSP_ABI="arm64-v8a"
  ...
  mips|mipsel)
	...
	CC_PREFIX="mipsel-linux-android$API_LEVEL-clang"
    AOSP_ABI="mips"
    AOSP_ARCH="arch-mips"
    AOSP_FLAGS="-funwind-tables -fexceptions -frtti"
    ;;
  mips64|mipsel64|mips64el)
	...
	CC_PREFIX="mips64el-linux-android$API_LEVEL-clang"
    AOSP_ABI="mips64"
  ...
  x86)
	...
	CC_PREFIX="i686-linux-android$API_LEVEL-clang"
    AOSP_ABI="x86"
    AOSP_ARCH="arch-x86"
  ...
  x86_64|x64)
	...
	CC_PREFIX="x86_64-linux-android$API_LEVEL-clang"
    AOSP_ABI="x86_64"
...
#from android-ndk-r20 we use llvm
AOSP_TOOLCHAIN_PATH=$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/linux-x86_64/bin
...
#export CPP=$AOSP_TOOLCHAIN_PATH/$CC_PREFIX++ --sysroot=$AOSP_SYSROOT
#export CC=$AOSP_TOOLCHAIN_PATH/$CC_PREFIX --sysroot=$AOSP_SYSROOT
#export CXX=$AOSP_TOOLCHAIN_PATH/$CC_PREFIX++ --sysroot=$AOSP_SYSROOT
export CFLAGS="-pie -fPIE"
export LDFLAGS="-pie -fPIE"
#####################################################################

export PREFIX=/usr/local/curl/$AOSP_ABI
export CC=$AOSP_TOOLCHAIN_PATH/$CC_PREFIX
...
./configure \
    ...
    --enable-shared \
    --host=$TOOLNAME_BASE \
	--with-ssl=/home/lxm/openssl-1.1.1b/output/$AOSP_ABI/
